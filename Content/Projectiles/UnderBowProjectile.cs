using DescentIntoUnderworld.Content.Items.Weapons.Ranger;
...
{
    public class UnderBowProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (shouldShootArrow && Main.myPlayer == Projectile.owner)
            {
                ...
                {
                    float holdoutDistance = UnderBow.HoldoutDistance * Projectile.scale;
